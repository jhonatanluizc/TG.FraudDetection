...
directoryFile = 'equalizedata.csv'
...
corte = int(0.80 * file.count().Class)

treino = file[:corte]
teste = file[corte:]

print("original {} registros".format(file.count().Class))
print("treino {} registros".format(treino.count().Class))
print("teste {} registros".format(teste.count().Class))

file.to_csv('original.csv', encoding='utf-8', index=False)
treino.to_csv('treino.csv', encoding='utf-8', index=False)
teste.to_csv('teste.csv', encoding='utf-8', index=False)
